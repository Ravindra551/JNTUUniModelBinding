<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Students.aspx.cs" Inherits="JNTUUniModelBinding.Students" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView runat="server" ID="studentsGrid"
        ItemType="JNTUUniModelBinding.Models.Student" DataKeyNames="StudentID"
